...
llm = ChatOpenAI(
    model=config.DOUBao_MODEL, base_url=config.DOUBao_BASE_URL, api_key=config.DOUBao_API_KEY, streaming=False
)
...
text = [
    ...
    {"type": "image_url", "image_url": {"url": f"data:image/jpeg;base64,{base}"}},
]
