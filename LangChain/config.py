...
SYSTEM_PROMPT_PATH = "E:\\Master\\ultralytics-main\\LangChain\\data\\system_prompt.txt"

# --- RAG 配置 ---
EMBEDDING_MODEL = "BAAI/bge-m3"
EMBEDDING_DEVICE = "cpu"  # 开发环境用 cpu，生产环境可改为 "cuda"
FAISS_INDEX_PATH = "E:\\Master\\ultralytics-main\\LangChain\\data\\faiss_index"
KNOWLEDGE_BASE_PATH = "E:\\Master\\ultralytics-main\\LangChain\\data\\knowledge_base.txt"
CHUNK_SIZE = 300
CHUNK_OVERLAP = 50
